...
export function NavBar ({children} ) {
    ...
    return (
        ...
        <div className="grid grid-cols-12 gap-4 auto-cols-max scroll-mx-15 pt-28">
              <div className="banner col-span-12 fixed top-0 left-0 right-0">
                      <a className='logo-lol cursor-pointer col-span-2' aria-label='League Of Legends' href='https://www.leagueoflegends.com/es-es/?_ga=2.29125311.2009624837.1707018719-494925846.1685050565&_gl=1*cg7hc5*_ga*NDk0OTI1ODQ2LjE2ODUwNTA1NjU.*_ga_FXBJE5DEDD*MTcwNzAxODcxOC4xMC4wLjE3MDcwMTg3MTguMC4wLjA.'target='blank' rel='norferrer'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="230" height="50" version="1.1" viewBox="0 0 600 229.42">
                              <g fill="#c79b3b">
                      ...
                      <div className="col-start-11 text-5xl">In a Nutshell</div>

              </div>
          
              <div className="grid child-container col-span-2">
                    <Link href="/"><a className='boton'>Inicio</a></Link>
                    <Link href="/noticias"><a className='boton'>Noticias</a></Link>
                    <Link href="/campeones"><a className='boton'>Campeones</a></Link>
                    <Link href="/patchnotes"><a className='boton'>PatchNotes</a></Link>
                    <Link href="/esports"><a className='boton'>Esports</a></Link>
              </div>

              <div className="justify-items-center col-span-8 grid grid-cols-1 gap-4"> 
              ...
              <div className="child-container justify-end col-auto ">
                    <h1>Hola</h1>
              </div>
